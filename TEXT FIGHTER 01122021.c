...
{
diceE = (rand() % 24 + diflev + diceR) + 1;//maybe 28 24 26 33 24 26 22 26
}
else
{
if ((choice == 'n') && (choice != 'm') && (choice != 's'))
diceE = (rand() % 32 + diflev) + 1;//maybe 32 0r 34 32 33 30 32 36
}
...
{
diceM = ((rand() % 70 + 1) + (diflev + 3));///diceM was 56///*************DIFLEV INCREMENT MUST BE AT 3!!! AT diflev + 2 MAGIC SUPER WILL NOT ACTIVATE ON + 30 DIFLEV!!!!!!!!!!!!!
if (diceR == 1)
{
diceR = (rand() % 12) + 1;//6 8
if (diceR == 1)
